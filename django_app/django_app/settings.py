...
SECRET_KEY = 'django-insecure-gp#pg=e=y4oo!)!44=d+v%nd870=0pwq4n0@+=ps0hm8mp$9ve'
...
STATICFILES_DIRS = [
    BASE_DIR / "static",           # 例えば、プロジェクト全体の静的ファイルディレクトリ
    BASE_DIR / "theme/static",     # Tailwind CSS用の静的ファイル
]
